...
class PendingResBills extends StatefulWidget {
  ...
  static Route route(settings) {
    return MaterialPageRoute(
      builder: (_) => ChangeNotifierProvider<PaidResBillProvider>(
        ...
        child: PendingResBills(),
      ),
      settings: settings,
    );
  }

  const PendingResBills({Key? key}) : super(key: key);

  @override
  _PendingResBillsState createState() => _PendingResBillsState();
}

class _PendingResBillsState extends State<PendingResBills> {
  @override
              ...
              child: ListView.separated(
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return RestaurantBillWidget(
                      ...
                      status:
                          item.status.toString().replaceAll("StatusType.", ""),
