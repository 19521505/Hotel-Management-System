        ...
        child: Column(
          children: [
            Container(
              ...
              child: argument.revenueReportProvider.checkEmptyInflowData(
                      argument.revenueReportProvider.reportList[argument.index])
                  ? Card(
                      elevation: 20,
            ...
            argument.revenueReportProvider.getTotalProfit(argument.index) < 0
                ? Card(
                    elevation: 20,
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(18)),
